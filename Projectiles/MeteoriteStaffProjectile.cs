...
{
    // Adds the Meteorite Staff Projectile which is displayed when using the Staff
    class MeteoriteStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/MeteoriteStaff";
