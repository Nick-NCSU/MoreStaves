...
namespace MoreStaves.Projectiles
{
    ...
    class CrimtaneStaffProjectile : ModProjectile
    {
        ...
        private void UpdatePlayerVisuals(Player player, Vector2 playerHandPos)
        {
            ...
            {
                projectile.Center = playerHandPos - projectile.Size - new Vector2(26, 10);
                projectile.rotation = -0.4f;
            }
            else
            {
                projectile.Center = playerHandPos - projectile.Size - new Vector2(38, 10);
                projectile.rotation = 0.4f;
            }
