...
{
    // Adds the Gold Staff Projectile which is displayed when using the Staff
    class GoldStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/GoldStaff";
