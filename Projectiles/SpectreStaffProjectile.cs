...
{
    // Adds the Spectre Staff Projectile which is displayed when using the Staff
    class SpectreStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/SpectreStaff";
