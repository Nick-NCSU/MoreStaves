...
{
    // Adds the Shroomite Staff Projectile which is displayed when using the Staff
    class ShroomiteStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/ShroomiteStaff";
