...
{
    // Adds the Luminite Staff Projectile which is displayed when using the Staff
    class LuminiteStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/LuminiteStaff";
