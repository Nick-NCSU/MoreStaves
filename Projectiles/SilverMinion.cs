...
{
	public class SilverMinion : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.SilverBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.SilverBuff>()))
			{
			...
			if (delay == 0)
			{
				if (foundTarget)
				{
					...
					Projectile.NewProjectile(projectile.Center, velocity, ModContent.ProjectileType<SilverProjectile>(), 11, 1, projectile.owner);
				}
			}
			else
			{
