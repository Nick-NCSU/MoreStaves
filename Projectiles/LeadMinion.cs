...
{
	public class LeadMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Lead");
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.LeadBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.LeadBuff>()))
			{
			...
			if (delay == 0)
			{
				if (foundTarget)
				{
					...
					Projectile.NewProjectile(projectile.Center, velocity, ModContent.ProjectileType<LeadProjectile>(), 12, 1, projectile.owner);
				}
			}
			else
			{
