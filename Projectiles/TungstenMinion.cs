...
{
	public class TungstenMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Tungsten");
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.TungstenBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.TungstenBuff>()))
			{
