...
{
    // Adds the Demonite Staff Projectile which is displayed when using the Staff
    class DemoniteStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/DemoniteStaff";
