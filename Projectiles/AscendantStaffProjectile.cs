...
{
    // Adds the Ascendant Staff Projectile which is displayed when using the Staff
    class AscendantStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/AscendantStaff";
