...
{
	public class TinMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Tin");
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.TinBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.TinBuff>()))
			{
			...
			if (delay == 0)
			{
				if (foundTarget)
				{
					...
					Projectile.NewProjectile(projectile.Center, velocity, ModContent.ProjectileType<TinProjectile>(), 10, 1, projectile.owner);
				}
			}
			else
			{
