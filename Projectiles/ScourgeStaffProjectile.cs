...
{
    // Adds the Scourge Staff Projectile which is displayed when using the Staff
    class ScourgeStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/ScourgeStaff";
