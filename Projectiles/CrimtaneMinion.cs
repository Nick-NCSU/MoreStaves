...
{
	// Adds the Crimtane Minion as a projectile.
	public class CrimtaneMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crimtane");
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.CrimtaneBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.CrimtaneBuff>()))
			{
		...
		// Minion inflicts venom debuff on npc hit
