...
{
    // Adds the Iron Staff Projectile which is displayed when using the Staff
    class IronStaffProjectile : ModProjectile
    {
        ...
        // Shares texture with Iron Staff
        public override string Texture => "MoreStaves/Items/IronStaff";
