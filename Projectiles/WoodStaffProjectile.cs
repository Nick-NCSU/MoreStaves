...
{
    // Adds the Wood Staff Projectile which is displayed when using the Staff
    class WoodStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/WoodStaff";
