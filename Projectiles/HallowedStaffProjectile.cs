...
{
    // Adds the Hallowed Staff Projectile which is displayed when using the Staff
    class HallowedStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/HallowedStaff";
