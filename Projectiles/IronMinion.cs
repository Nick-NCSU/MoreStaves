...
{
	public class IronMinion : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.IronBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.IronBuff>()))
			{
			...
			if (delay == 0)
			{
				if (foundTarget)
				{
					...
					Projectile.NewProjectile(projectile.Center, velocity, ModContent.ProjectileType<IronProjectile>(), 11, 1, projectile.owner);
				}
			}
			else
			{
