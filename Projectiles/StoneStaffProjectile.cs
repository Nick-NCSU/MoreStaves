...
{
    // Adds the Stone Staff Projectile which is displayed when using the Staff
    class StoneStaffProjectile : ModProjectile
    {
        ...
        public override string Texture => "MoreStaves/Items/StoneStaff";
